...
public class AuditeurCNAMTest extends junit.framework.TestCase {
    ...
    public void test_nom_avec_accent() {
        ...
        public void test_nom_avec_accents() {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("Chloéé",
                "chloéé", "12345");
        assertEquals("Mme Chloéé chloéé ", "Chloéé", auditeur1.nom());
        assertEquals("Mme Chloéé chloéé ", "chloéé", auditeur1.prenom());
        assertEquals(" nom avec accent (é devient e) ? ", "chloee_c",
            auditeur1.login());
    }
}
